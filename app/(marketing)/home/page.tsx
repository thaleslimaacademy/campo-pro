...
export default function LandingPage() {
  ...
  const dores = [
    { icon: 'ti-clock', titulo: 'Horas perdidas todo mes', desc: 'Cobrando mensalidade por WhatsApp uma a uma, conferindo pagamentos manualmente e criando listas de presenca no papel.' },
    { icon: 'ti-alert-triangle', titulo: 'Inadimplencia fora de controle', desc: 'Sem visibilidade de quem pagou, quem esta atrasado e quanto voce esta perdendo todo mes. A academia sangra dinheiro sem que voce perceba.' },
  ...
  const funcionalidades = [
    { icon: 'ti-credit-card', cor: '#4ADE80', titulo: 'Cobranca automatica', desc: 'Boletos gerados e enviados por WhatsApp automaticamente. O sistema cobra, voce recebe.' },
    { icon: 'ti-check', cor: '#00BFFF', titulo: 'Presenca digital', desc: 'Controle de frequencia por turma em segundos. Relatorio completo no final do mes.' },
    { icon: 'ti-message-circle', cor: '#7DD3FC', titulo: 'WhatsApp integrado', desc: 'Mensagens automaticas para pais sobre pagamentos, treinos, convocacoes e noticias da academia.' },
    { icon: 'ti-chart-bar', cor: '#FFD700', titulo: 'Dashboard financeiro', desc: 'Visualize em tempo real: receita prevista, recebida, inadimplencia e ticket medio.' },
    { icon: 'ti-users', cor: '#FB923C', titulo: 'App dos pais', desc: 'Os pais acompanham o desenvolvimento, conquistas e avaliacoes fisicas do filho direto no celular.' },
    { icon: 'ti-medal', cor: '#F472B6', titulo: 'Premiacoes e conquistas', desc: 'Sistema de conquistas que motiva os atletas e aumenta a retencao na sua academia.' },
    { icon: 'ti-run', cor: '#4169E1', titulo: 'Gestao de turmas', desc: 'Organize atletas por categoria, horario e modalidade. Controle total do seu elenco.' },
    { icon: 'ti-trophy', cor: '#A78BFA', titulo: 'Campeonatos', desc: 'Gerencie competicoes, convocacoes e resultados em um unico lugar.' },
  ]

  const numeros = [
    { valor: '350+', label: 'Atletas gerenciados', cor: '#00BFFF' },
    { valor: '15h', label: 'Economizadas por semana', cor: '#4ADE80' },
    { valor: '100%', label: 'Operacao centralizada', cor: '#FFD700' },
    { valor: '0', label: 'Planilhas e papeis', cor: '#F472B6' },
  ]
    ...
    <div style={{ background: '#080810', color: '#F0F4FF', fontFamily: INTER, minHeight: '100vh' }}>
      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 100, background: 'rgba(8,8,16,0.95)', borderBottom: '1px solid rgba(65,105,225,0.2)', backdropFilter: 'blur(12px)', padding: '14px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
          ...
          <a href="/planos" style={{ background: '#4169E1', color: '#fff', padding: '8px 20px', borderRadius: 8, fontSize: 14, fontWeight: 700, textDecoration: 'none', fontFamily: SYNE }}>Comecar gratis</a>
        </div>
      </nav>
      ...
      <section style={{ padding: '80px 24px 60px', textAlign: 'center', maxWidth: 900, margin: '0 auto', position: 'relative' }}>
        ...
        <p style={{ fontSize: 18, color: 'rgba(240,244,255,0.65)', lineHeight: 1.7, maxWidth: 640, margin: '0 auto 40px' }}>
          Menos tempo com cobrancas, planilhas e WhatsApp manual. Mais tempo formando atletas. GestaoFC centraliza toda a operacao da sua escolinha em um unico sistema.
        </p>
      ...
      <section style={{ padding: '80px 24px', maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 56 }}>
          <h2 style={{ fontFamily: SYNE, fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 900, color: '#F0F4FF', marginBottom: 16 }}>
            Voce se identifica com alguma dessas situacoes?
          </h2>
      ...
      <section id="funcionalidades" style={{ padding: '80px 24px', maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 56 }}>
          <h2 style={{ fontFamily: SYNE, fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 900, color: '#F0F4FF', marginBottom: 16 }}>
            Tudo que sua academia precisa,<br /><span style={{ color: '#4169E1' }}>em um unico lugar.</span>
          </h2>
          <p style={{ fontSize: 16, color: 'rgba(240,244,255,0.5)', maxWidth: 560, margin: '0 auto' }}>
            Nao e mais um app. E o sistema operacional completo da sua escolinha.
          </p>
        </div>
      ...
      <section style={{ padding: '80px 24px', textAlign: 'center', maxWidth: 700, margin: '0 auto' }}>
        ...
        <p style={{ fontSize: 16, color: 'rgba(240,244,255,0.5)', lineHeight: 1.7, marginBottom: 36 }}>
          Junte-se aos gestores que ja pararam de perder tempo com burocracia e passaram a focar no que importa: formar atletas e crescer.
        </p>
        ...
        <p style={{ fontSize: 12, color: 'rgba(240,244,255,0.25)', marginTop: 12 }}>Sem cartao de credito para comecar.</p>
      </section>
